...
Welcome to `Finance and ML` contributor's guide.
...
If you experience bugs or general issues with `Finance and ML`, please have a look
...
You can help improve `Finance and ML` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`Finance and ML` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `Finance and ML`'s files. While this mechanism can
...
```
conda create -n Finance and ML python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/Finance and ML.git
   cd Finance and ML
   ```
...
5. Install [pre-commit]:
   ...
   `Finance and ML` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/Finance and ML
[issue tracker]: https://github.com/<USERNAME>/Finance and ML/issues
